...
export const Header = () => {
  ...
  return (
    <header className="text-white px-6 py-16">
      <div className="container mx-auto flex justify-around items-start flex-row gap-10 xl:gap-0 flex-wrap relative">
        <Spotlight />
        <Spotlight />
        ...
        <div>
          ...
          <div>
            <Image
              ...
              width={300}
              height={200}
              className="w-80 h-80 rounded-full shadow-lg z-10"
            />
          </div>
          {/* </BackgroundLines> */}
        </div>
